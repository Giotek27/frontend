<template>
<div>
<h1>Tabla de datos de servicios</h1>
    <div>
        <nav class="navbar navbar-expand-lg navbar-dark bg-success">
            ...
            <b-navbar-nav class="ml-auto">
                 <b-nav-item>
                    <router-link :to="{name:'crearservicios'}" class="btn btn-outline-light" >
                ...
                <b-nav-item><div class="d-flex" >
                    ...
                    type="search" 
                    placeholder="consultar por Tipo servicio" 
                    aria-label="search" 
    ...
    <table class="table table-bordered"> 
        <thead>
            ...
            <th scope="col">cantidad de plastico</th>
            </tr>
        </thead>
        <tbody>
            <tr id ="tabla" v-for="usuario in usuarios" :key="usuario.id">
                ...
                <td>
                    ...
                    <router-link :to="{name: 'editarservicios', 
...
<script>
    ...
    export default {
        data() {
            ...
            created(){
                axios.get("https://backend54-7.herokuapp.com/consultarservicios").then((res)=>this.usuarios=res.data);
            },
            methods:{
                deleteusuario(id){
                let indexofArrayItem=this.usuarios.findIndex((i)=>i._id === id);
                axios.delete("https://backend54-7.herokuapp.com/borrarservicios/"+id).then(()=>console.log("El registro se ha eliminado"));
                this.usuarios.splice(indexofArrayItem,1);
                alert("El registro se ha eliminado");
            },
            consultarVendedorN(){
                const API="https://backend54-7.herokuapp.com/buscaservicios/"+this.buscarusuario;
                console.log(API);
