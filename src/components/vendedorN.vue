    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-dark bg-success">
            ...
            <b-navbar-nav class="ml-auto">
                 <b-nav-item>
                    <router-link :to="{name:'crearvendedorn'}" class="btn btn-outline-light" >
        ...
        <tbody>
            <tr id ="tabla" v-for="usuario in usuarios" :key="usuario.id">
                ...
                <td>
                    ...
                    <router-link :to="{name: 'editarvendedorn', 
...
<script>
    ...
    export default {
        data() {
            ...
            consultarVendedorN(){
                const API="https://backend54-7.herokuapp.com/buscavendedornombre/"+this.buscarusuario;
                console.log(API);
